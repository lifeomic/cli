...
exports.command = 'create-copy-number-set <datasetId>';
exports.desc = 'Create copy number genomic resources by indexing a CNV file';
exports.builder = yargs => {
  yargs.positional('datasetId', {
    ...
    alias: 'n',
    type: 'string'
  }).option('copy-number-file', {
    describe: 'The ID of the CNV file to index',
    alias: 'f',
    type: 'string',
    demandOption: true
  }).option('patient', {
...
exports.handler = async argv => {
  const response = await post(argv, '/copynumbersets', {
    datasetId: argv.datasetId,
    fileId: argv.copyNumberFile,
    name: argv.name,
