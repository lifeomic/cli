...
exports.command = 'create-nantomics-bulk-import <datasetId>';
exports.desc = 'Create a task to ingest a Nantomics Bulk TAR file';
exports.builder = yargs => {
  yargs.positional('datasetId', {
    describe: 'The dataset Id.',
    type: 'string'
  }).option('tar-file-id', {
    describe: 'The ID of the uploaded TAR file',
    alias: 'f',
    type: 'string',
    demandOption: true
  }).option('subject-id', {
...
exports.handler = async argv => {
  const response = await post(argv, `/v1/tasks/system/nantomics-bulk-import`, {
