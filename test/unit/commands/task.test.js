...
test.serial.cb('The "create-nantomics-bulk-import" command should create a nant bulk ingest task', t => {
  const res = { data: {} };
  postStub.onFirstCall().returns(res);
  callback = () => {
    t.is(postStub.callCount, 1);
    t.is(postStub.getCall(0).args[1], '/v1/tasks/system/nantomics-bulk-import');
    t.deepEqual(postStub.getCall(0).args[2], {
      tarFileId: 'c8ef7300-1373-4e51-8eb9-ff333600f6a5',
      datasetId: 'db3e09e9-1ecd-4976-aa5e-70ac7ada0cc3',
      subjectId: '2a6dc73e-ed30-4387-94c1-0cd661da56d9',
  ...
  yargs.command(createNantBulkTask)
    .parse('create-nantomics-bulk-import db3e09e9-1ecd-4976-aa5e-70ac7ada0cc3 -f c8ef7300-1373-4e51-8eb9-ff333600f6a5 ' +
      '-s 2a6dc73e-ed30-4387-94c1-0cd661da56d9 --performer-id performer1 --indexed-date "1999-01-01" ' +
      '--body-site "Colon" --body-site-system "http://a.fancy.system.com"  ' +
      '--body-site-display "body site notation" --re-ingest-file --send-failed-to failed@user.com');
});
